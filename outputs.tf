output "alb_controller_irsa_role_arn" {
  ...
  value       = var.services.aws-alb-ingress-controller.enabled ? module.aws-alb-ingress-controller[0].irsa_role_arn : "Not Installed"
}
...
output "alb_controller_irsa_role_id" {
  ...
  value       = var.services.aws-alb-ingress-controller.enabled ? module.aws-alb-ingress-controller[0].irsa_role_id : "Not Installed"
}
...
output "autoscaler_irsa_role_arn" {
  ...
  value       = var.services.cluster-autoscaler.enabled ? module.cluster-autoscaler[0].irsa_role_arn : "Not Installed"
}
...
output "autoscaler_irsa_role_id" {
  ...
  value       = var.services.cluster-autoscaler.enabled ? module.cluster-autoscaler[0].irsa_role_id : "Not Installed"
}

output "external_dns_irsa_role_arn" {
  description = "The ARN of the IAM role used by the External DNS controller for IRSA (IAM Roles for Service Accounts)."
  value       = var.services.external-dns.enabled ? module.external-dns[0].irsa_role_arn : "Not Installed"
}
...
output "external_dns_irsa_role_id" {
  ...
  value       = var.services.external-dns.enabled ? module.external-dns[0].irsa_role_id : "Not Installed"
}
...
output "external_secrets_irsa_role_arn" {
  ...
  value       = var.services.external-secrets.enabled ? module.external-secrets[0].irsa_role_arn : "Not Installed"
}
...
output "external_secrets_irsa_role_id" {
  ...
  value       = var.services.external-secrets.enabled ? module.external-secrets[0].irsa_role_id : "Not Installed"
}
...
output "metrics_server_irsa_role_arn" {
  ...
  value       = var.services.metrics-server.enabled ? module.metrics-server[0].irsa_role_arn : "Not Installed"
}
...
output "metrics_server_irsa_role_id" {
  ...
  value       = var.services.metrics-server.enabled ? module.metrics-server[0].irsa_role_id : "Not Installed"
}
...
output "karpenter_irsa_role_id" {
  ...
  value       = var.services.karpenter.enabled ? module.karpenter[0].iam_role_name : "Not Installed"
}

output "karpenter_node_iam_role_name" {
  description = "The ID of the IAM role used by the Karpenter for IRSA (IAM Roles for Service Accounts)."
  value       = var.services.karpenter.enabled ? module.karpenter[0].node_iam_role_name : "Not Installed"
}

output "karpenter_default_node_class_name" {
  description = "The ID of the IAM role used by the Karpenter for IRSA (IAM Roles for Service Accounts)."
  value       = var.services.karpenter.enabled ? var.services.karpenter.default_nodeclass_name : "Not Installed"
}
